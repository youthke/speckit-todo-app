...
describe('TaskItem Component', () => {
  ...
  test('renders task information correctly', () => {
    render(<TaskItem task={mockTask} onTaskChange={mockOnTaskChange} />);
  ...
  test('renders completed task with different styling', () => {
    ...
    render(<TaskItem task={completedTask} onTaskChange={mockOnTaskChange} />);
  ...
  test('saves edited title when save button is clicked', async () => {
    const updatedTask = { ...mockTask, title: 'Buy groceries and cook' };
    mockApi.updateTask.mockResolvedValue(updatedTask);
